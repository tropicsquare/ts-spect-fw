...
if __name__ == "__main__":
    ...
    ehpriv_scalar = models.x25519.int2scalar()
...
# ===================================================================================
    ...
    etpub = tc.read_output(f"{test_dir}/x25519_kpair_gen_out.hex", 0x1020, SPECT_OP_DATA_OUT_SIZE//4)
...
# ===================================================================================
    ...
    X1_ref = models.x25519.x25519(etpriv, ehpub)
    ...
    X1 = tc.read_output(f"{test_dir}/x25519_sc_et_eh_out.hex", 0x1020, SPECT_OP_DATA_OUT_SIZE//4)
...
# ===================================================================================
    ...
    R2 = tc.read_output(f"{test_dir}/x25519_sc_et_sh_out.hex", 0x1020, SPECT_OP_DATA_OUT_SIZE//4)
...
# ===================================================================================
    ...
    R3 = tc.read_output(f"{test_dir}/x25519_sc_st_eh_out.hex", 0x1020, SPECT_OP_DATA_OUT_SIZE//4)
